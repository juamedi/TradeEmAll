...
public class DBTrades {
    ...
    public static int createTrade(int pkm_give_id, int pkm_receive_id, User user) throws Exception {
        ...
        String sql = "INSERT INTO Trade (active, give_user_id, receive_user_id, "
        ...
        try {
            ...
            ps.setString(3, null);
            ps.setInt(4, pkm_give_id);
            ps.setInt(5, pkm_receive_id);
            ps.executeUpdate();
    ...
    public static ArrayList<Trade> lookTrade (Pokemon pkm, User user) throws Exception {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                give_pkm.setPkmId(rs.getInt(5));
                give_pkm.setName(rs.getString(8));
                give_pkm.setLvl(rs.getInt(9));
                give_pkm.setGender(rs.getString(10));
                give_pkm.setShiny(rs.getBoolean(11));
                give_pkm.setAbility(rs.getString(12));
                give_pkm.setMove1(rs.getString(13));
                give_pkm.setMove2(rs.getString(14));
                give_pkm.setMove3(rs.getString(15));
                give_pkm.setMove4(rs.getString(16));
                give_pkm.setNature(rs.getString(17));
                give_pkm.setIVHP(rs.getInt(18));
                give_pkm.setIVATK(rs.getInt(19));
                give_pkm.setIVDEF(rs.getInt(20));
                give_pkm.setIVSPA(rs.getInt(21));
                give_pkm.setIVSPD(rs.getInt(22));
                give_pkm.setIVSPE(rs.getInt(23));
                give_pkm.setEVHP(rs.getInt(24));
                give_pkm.setEVATK(rs.getInt(25));
                give_pkm.setEVDEF(rs.getInt(26));
                give_pkm.setEVSPA(rs.getInt(27));
                give_pkm.setEVSPD(rs.getInt(28));
                give_pkm.setEVSPE(rs.getInt(29));

                receive_pkm.setPkmId(rs.getInt(30));
                receive_pkm.setName(rs.getString(31));
                receive_pkm.setLvl(rs.getInt(32));
                receive_pkm.setGender(rs.getString(33));
                receive_pkm.setShiny(rs.getBoolean(34));
                receive_pkm.setAbility(rs.getString(35));
                receive_pkm.setMove1(rs.getString(36));
                receive_pkm.setMove2(rs.getString(37));
                receive_pkm.setMove3(rs.getString(38));
                receive_pkm.setMove4(rs.getString(39));
                receive_pkm.setNature(rs.getString(40));
                receive_pkm.setIVHP(rs.getInt(41));
                receive_pkm.setIVATK(rs.getInt(42));
                receive_pkm.setIVDEF(rs.getInt(43));
                receive_pkm.setIVSPA(rs.getInt(44));
                receive_pkm.setIVSPD(rs.getInt(45));
                receive_pkm.setIVSPE(rs.getInt(46));
                receive_pkm.setEVHP(rs.getInt(47));
                receive_pkm.setEVATK(rs.getInt(48));
                receive_pkm.setEVDEF(rs.getInt(49));
                receive_pkm.setEVSPA(rs.getInt(50));
                receive_pkm.setEVSPD(rs.getInt(51));
                receive_pkm.setEVSPE(rs.getInt(52));

                dbtrade.setGiveUsername(rs.getString(53));
    ...
    public static ArrayList<Trade> lookTradeOffer (User user) throws Exception {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                trade.setOfferEstado(rs.getString(5));
